    ...
    return (
        <form className="flashcard-form" onSubmit={handleSubmit(onSubmit)}>
            ...
            <label>
                Answer *
                <textarea 
                    {...register("answer", { required: "Answer is required", minLength: { value: 10, message: "Min length is 10 characters" }, maxLength: { value: 250, message: "Max length is 250 characters" } })} 
                />
